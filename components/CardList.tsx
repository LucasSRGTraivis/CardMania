    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-cream-200">
      ...
      <div className="md:hidden divide-y divide-cream-200">
        {cards.map((card) => {
          ...
          return (
            <div key={card.id} className="px-3 py-2.5 flex gap-3 items-stretch">
              <div className="flex-1 flex flex-col gap-1.5">
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] text-forest-700">
                  ...
                  {typeLabel !== '—' && (
                    <>
                      <span className="w-1 h-1 rounded-full bg-cream-400" />
                      <span className="truncate max-w-[60%]">{typeLabel}</span>
                    </>
                  )}
                </div>
                ...
                <div className="flex justify-start gap-1.5 pt-1">
                  <button
                    onClick={() => onEdit(card)}
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-forest-100 text-forest-900 text-[11px] font-medium hover:bg-forest-200 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-red-100 text-red-700 text-[11px] font-medium hover:bg-red-200 transition-colors"
                  >
              ...
              {card.main_image_url && (
                <div className="w-14 sm:w-16 rounded-lg overflow-hidden bg-gradient-to-br from-cream-100 to-forest-50 shrink-0 self-stretch">
                  <img
